...
TSharedPtr< FSlateStyleSet > FMyStandaloneWindowPluginStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FMyStandaloneWindowPluginStyle::Create()
{
	...
	Style->Set("MyStandaloneWindowPlugin.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
